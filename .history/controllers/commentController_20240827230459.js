...
import { createComment, getCommentsByPostId, updateCommentById, deleteCommentById } from '../models/comment.js';
...
const modifyComment = (req, res, next) => {
  try {
    ...
    const updatedComment = updateCommentById(commentId, content, userId);
...
const removeComment = (req, res, next) => {
  try {
    ...
    const isDeleted = deleteCommentById(commentId, userId);
